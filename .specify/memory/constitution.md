...
- Modified principles: n/a (first adoption; all 10 principles newly defined)
...
- Removed sections: none (initial adoption from template scaffold)
- Templates requiring updates: not modified by this command (dependent templates read this
  constitution at runtime per scope guard); recommend running /speckit-plan or /speckit-tasks
  next for any active feature to confirm alignment with the new gates (grounding eval,
  retrieval eval, KB-schema review).
- Deferred TODOs: none
-->
